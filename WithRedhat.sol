...
contract TRDCvalut is BEP20 {
  ...
  modifier setPower(address _Player){
    ...
    function getPlayerThiefs() public view returns(string memory _thiefName, uint _thiefPower){  
    ...
    function getPlayerCops() public view returns(string memory _copName, uint _copPower){  
    ...
    function getPlayerWeapons() public view returns(string memory _weaponName, uint _weaponPower){  
